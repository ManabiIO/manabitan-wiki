...
If you are an existing user of Yomichan, you can export your dictionary collection and settings such that they can be imported into Manabitan to reflect your setup exactly as it was.
...
You can then import the exported files into Manabitan from the `Backup` section of the `Settings` page. Please see [the dictionary installation guide](getting-started.md#installing-dictionaries) for more explicit steps.
...
This revealed a bug in four of Manabitan's template helpers, which have now been fixed in the default templates. If your
